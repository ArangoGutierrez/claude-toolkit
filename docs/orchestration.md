...
and anything you'd finish before automation could pay for itself.
...
|---|---|---|
| Loops | `/loop` (Cursor command) | re-run a task until its completion phrase appears, bounded by `--max` iterations |
