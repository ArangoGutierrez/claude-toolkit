...
scripts themselves are in [`.claude/hooks/`](https://github.com/ArangoGutierrez/claude-toolkit/tree/main/.claude/hooks/).
...
contract is in [`verify-gate.README.md`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/hooks/verify-gate.README.md).
...
[`.claude/hooks/README.md`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/hooks/README.md).
...
[`constitution.md`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/rules/constitution.md) rule — loaded into every
...
Evals live in [`.claude/evals/`](https://github.com/ArangoGutierrez/claude-toolkit/tree/main/.claude/evals/). Each one is a small,
...
[`TEMPLATE.eval.sh`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/evals/TEMPLATE.eval.sh) is a runnable skeleton
to copy.
...
[`.claude/evals/README.md`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/evals/README.md).
...
- **Fully-specified briefs.** One agent implements exactly one task from a
  ...
  [`team-plan`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/skills/team-plan/README.md) skill decomposes work
...
- **Isolated worktrees.** Each worker implements in its own Git worktree, so
  ...
  The [`team-execute`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/skills/team-execute/README.md) skill spawns
  the workers; [`team-shutdown`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/skills/team-shutdown/README.md)
  retires them.
...
- **An adversarial review gate.** Before anything merges, a reviewer reads the
  ...
  [`principal-engineer`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/agents/principal-engineer.md) (architecture,
  conventions, security) and [`qa-engineer`](https://github.com/ArangoGutierrez/claude-toolkit/blob/main/.claude/agents/qa-engineer.md)
